    ...
    var library = (function () {
        ...
        function Book(book) {
            if (typeof book.title !== 'string' ||
                ...
                throw 'Title must be between 2-100 characters';
            }
            ...
            if (typeof book.isbn !== 'string' ||
                ...
                throw 'ISBN must be an unique code that contains either 10 or 13 digits';
            }
            this.ID = bookID + 1;
        ...
        function Category(name) {
            if (typeof name !== 'string' || name.length < 2 || name.length > 100) {
                throw 'Category must be between 2-100 characters';
            }
